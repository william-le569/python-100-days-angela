...
def is_known():
    ...
    data.to_csv("data/words_to_learn.csv", index=False) # not add index number to csv file.
    next_card()
...
card_title = canvas.create_text(400, 150, text="Title", font=("Ariel", 40, "italic")) # These positions are relative to the canvas.
